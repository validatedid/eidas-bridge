...
from demo.data.common_data import credentials, bad_credentials, test_proof, test_credentials, eidas_data_list, unique_credentials
import json
...
@pytest.mark.parametrize("credential", unique_credentials)
