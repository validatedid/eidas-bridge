...
<head>
    ...
    <script src="../assets/js/vidchain_login.js"></script>
...
<div class="container">
    <div>
        <div class="offset-by-four four columns" style="margin-top: 5%; margin-bottom: 5%;text-align: center; color:white;">        
                <img id="qr-code" class="qr" src="<?php echo "http://localhost/~albertsolana/Projects/08.eIDAS_Bridge/eidas-bridge/demo/verifier-portal/qr.php?id=".$qrId; ?>"/>
